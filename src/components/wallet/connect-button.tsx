...
import { ChevronDown, LogOut, Wallet, Copy, Check, ExternalLink, AlertCircle, ShieldCheck } from "lucide-react"
...
const walletIcons: Record<string, React.ReactNode> = {
  MetaMask: <img src="/placeholder.svg?height=24&width=24" alt="MetaMask" className="h-6 w-6" />,
  WalletConnect: <img src="/placeholder.svg?height=24&width=24" alt="WalletConnect" className="h-6 w-6" />,
  "Coinbase Wallet": <img src="/placeholder.svg?height=24&width=24" alt="Coinbase Wallet" className="h-6 w-6" />,
...
export function ConnectButton() {
      ...
      <TooltipProvider>
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button variant="outline" className="flex items-center gap-2 h-10 px-4 transition-all hover:bg-accent">
              <div className="flex items-center gap-2">
                ...
                <Avatar className="h-6 w-6 border border-border">
                  <AvatarImage src={`https://effigy.im/a/${address}.svg`} alt="Avatar" />
                  <AvatarFallback>
          ...
          <DropdownMenuContent align="end" className="w-64">
            ...
            <DropdownMenuGroup>
              <Tooltip>
                <TooltipTrigger asChild>
                  <DropdownMenuItem className="flex items-center justify-between cursor-pointer" onClick={copyAddress}>
                    <div className="flex items-center gap-2">
            ...
            <DropdownMenuSeparator />
            <DropdownMenuItem className="flex items-center gap-2" onClick={() => disconnect()}>
  ...
  return (
    <>
      <Button onClick={() => setIsDialogOpen(true)} className="flex items-center gap-2" size="default">
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>Choose your preferred wallet provider to connect to this application.</DialogDescription>
          </DialogHeader>
                ...
                >
                  <Card
                    className={`cursor-pointer transition-all ${
                      isReady ? "hover:border-primary/50 hover:shadow-sm" : "opacity-60"
                    }`}
                  >
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            {!isReady && <CardDescription className="text-xs">Not installed</CardDescription>}
                          </div>
                        </div>
                        {!isReady && (
                          <Badge
