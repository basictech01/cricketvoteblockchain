                ...
                >
                  <Card className="w-full max-w-md overflow-hidden border-primary/20">
                    <CardHeader className="bg-primary/5 text-center">
                      ...
                      <CardDescription>
                        Connect your wallet to start making predictions on
                        cricket matches and earn rewards.
                      </CardDescription>
                    </CardHeader>
        ...
        >
          <DialogContent className="sm:max-w-md">
            ...
            <div className="flex flex-col items-center gap-4 py-4">
              ...
              <div className="text-sm text-muted-foreground text-center">
                The transaction is being processed. This may take a few minutes
                to complete.
              </div>
            </div>
            <DialogFooter className="flex justify-center sm:justify-center gap-2">
              ...
              <div className="p-6">
                {selectedMatchDetails && (
                  <>
                    ...
                    {getClaimableTokens(selectedMatchDetails.predictions) >
                      0 && (
